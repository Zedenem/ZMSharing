...
- (void) loadView {
	...
	label.text = NSLocalizedStringFromTable(@"Sharing_Library_OAuthTwitterController_PLEASE_WAIT", @"Sharing_Library", @"");
	...
	UINavigationItem				*navItem = [[[UINavigationItem alloc] initWithTitle: NSLocalizedStringFromTable(@"Sharing_Library_OAuthTwitterController_TWITTER_INFO", @"Sharing_Library", @"")] autorelease];
...
- (UIToolbar *) pinCopyPromptBar {
	if (_pinCopyPromptBar == nil){
		...
		_pinCopyPromptBar.items = [NSArray arrayWithObjects: 
							  ...
							  [[[UIBarButtonItem alloc] initWithTitle: NSLocalizedStringFromTable(@"Sharing_Library_OAuthTwitterController_SELECT_COPY_PIN", @"Sharing_Library", @"") style: UIBarButtonItemStylePlain target: nil action: nil] autorelease], 
							  [[[UIBarButtonItem alloc] initWithBarButtonSystemItem: UIBarButtonSystemItemFlexibleSpace target: nil action: nil] autorelease], 
							nil];
	}
