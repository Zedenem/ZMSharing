 ...
 */
- (void)authorizeWithPermissions:(NSArray *)permissions fbAppAuth:(BOOL)fbAppAuth safariAuth:(BOOL)safariAuth {
	self.permissions = permissions;
	
	[self authorizeWithFBAppAuth:fbAppAuth safariAuth:safariAuth];
}
